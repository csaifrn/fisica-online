! function(e, t) {
    ...
    for (var t = {
            ...
            17: !1,
            91: !1
        }, g = {}, n = 1; n < 20; n++) t["f".concat(n)] = 111 + n;
    var v = [],
        o = "all",
        w = [],
        k = function(e) {
        ...
        d(e.key).forEach(function(e) {
            ...
            g[e] && (i = i || O(), t = 1 < o ? p(y, n) : [], g[e] = g[e].map(function(e) {
                return r && e.method !== r || e.scope !== i || ! function(e, t) {
                    for (var n = e.length < t.length ? t : e, o = e.length < t.length ? e : t, i = !0, r = 0; r < n.length; r++) ~o.indexOf(n[r]) || (i = !1);
                    return i
                }(e.mods, t) ? e : {}
            }))
        })
    ...
    function K(e, t, n) {
        ...
        if (t.scope === n || "all" === t.scope) {
            for (var i in o = 0 < t.mods.length, m) Object.prototype.hasOwnProperty.call(m, i) && (!m[i] && ~t.mods.indexOf(+i) || m[i] && !~t.mods.indexOf(+i)) && (o = !1);
    ...
    function b(n) {
        ...
        if (x.filter.call(this, n)) {
            ...
            for (var i in m) Object.prototype.hasOwnProperty.call(m, i) && (m[i] = n[h[i]]);
            ...
            var r = O();
            if (e)
                for (var f = 0; f < e.length; f++) e[f].scope === r && ("keydown" === n.type && e[f].keydown || "keyup" === n.type && e[f].keyup) && K(n, e[f], r);
            if (t in g)
                for (var a = 0; a < g[t].length; a++)
                    if (("keydown" === n.type && g[t][a].keydown || "keyup" === n.type && g[t][a].keyup) && g[t][a].key) {
                        for (var c = g[t][a], l = c.key.split(c.splitKey), s = [], u = 0; u < l.length; u++) s.push(k(l[u]));
        ...
        deleteScope: function(e, t) {
            ...
            for (i in e = e || O(), g)
                if (Object.prototype.hasOwnProperty.call(g, i))
                    for (n = g[i], o = 0; o < n.length;) n[o].scope === e ? n.splice(o, 1) : o++;
            O() === e && r(t || "all")
        },
